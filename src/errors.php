<!-- general error page to display all errors -->
<!doctype html>
<html lang="en">
...
<body>
    <!-- nav bar -->
    <nav class="navbar navbar-expand-lg navbar-light bg-danger mb-2">
        <a class="navbar-brand" href="#">General guidelines </a>
  ...
  <hr class="my-4">
  <p class="lead">
    <b>3.Empty fields are not allowed </b>
  </p>
